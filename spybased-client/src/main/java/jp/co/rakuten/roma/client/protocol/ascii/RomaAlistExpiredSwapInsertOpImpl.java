...
public class RomaAlistExpiredSwapInsertOpImpl extends OperationImpl
	...
	private static final String cmd = "alist_expired_swap_and_insert ";
	private static final Integer cmdsize=cmd.length();
	private final String key;
	private final Long expire;
	protected final byte[] data;

	public RomaAlistExpiredSwapInsertOpImpl(OperationCallback cb, String k,Long e,byte [] d) {
		super(cb);
		key=k;
		data=d;
		expire=e;
