...
public class RomaAlistExpiredSwapPushOpImpl extends OperationImpl
	...
	private final static String cmd = "alist_expired_swap_and_push ";
	private static final Integer cmdsize=cmd.length();
	private final String key;
	private final Long expire;
	protected final byte[] data;

	public RomaAlistExpiredSwapPushOpImpl(OperationCallback cb, String k,Long e,byte [] d) {
		super(cb);
		key=k;
		data=d;
		expire=e;
