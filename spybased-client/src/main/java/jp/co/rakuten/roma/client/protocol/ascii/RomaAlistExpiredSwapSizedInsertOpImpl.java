...
public class RomaAlistExpiredSwapSizedInsertOpImpl extends OperationImpl
	...
	private static final String cmd = "alist_expired_swap_and_sized_insert ";
	...
	public RomaAlistExpiredSwapSizedInsertOpImpl(OperationCallback cb, String k,Long e,Integer s,byte [] d) {
		super(cb);
		key=k;
		data=d;
		expire=e;
