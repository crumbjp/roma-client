...
public class RomaAlistGetsOpImpl extends RomaAlistBaseGetsOpImpl
	implements RomaExtensionOperation{

	private static final int OVERHEAD = 32;
	private static final String cmd = "alist_gets ";
	private static final Integer cmdsize=cmd.length();
	private final String key;
	private final Integer index;
	private final Integer range;

	public RomaAlistGetsOpImpl(OperationCallback cb, String k,Integer i,Integer r) {
		super(cb);
		key = k;
		index = i;
		range = r;
