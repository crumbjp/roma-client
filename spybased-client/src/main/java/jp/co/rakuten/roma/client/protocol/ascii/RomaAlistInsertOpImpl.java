...
public class RomaAlistInsertOpImpl extends OperationImpl
	...
	private static final String cmd = "alist_insert ";
	private static final Integer cmdsize=cmd.length();
	private final String key;
	private final Integer index;
	protected final byte[] data;

	public RomaAlistInsertOpImpl(OperationCallback cb, String k,Integer i,byte [] d) {
		super(cb);
		key=k;
		data=d;
		index=i;
