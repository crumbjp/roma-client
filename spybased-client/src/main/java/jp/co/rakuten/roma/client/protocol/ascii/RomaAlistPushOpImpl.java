...
public class RomaAlistPushOpImpl extends OperationImpl
	...
	private static final String cmd = "alist_push ";
	private static final Integer cmdsize=cmd.length();
	private final String key;
	protected final byte[] data;

	public RomaAlistPushOpImpl(OperationCallback cb, String k,byte [] d) {
		super(cb);
		key=k;
		data=d;
	}
