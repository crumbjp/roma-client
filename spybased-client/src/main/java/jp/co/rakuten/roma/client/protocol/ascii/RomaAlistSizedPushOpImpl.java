...
public class RomaAlistSizedPushOpImpl extends OperationImpl
	...
	private static final String cmd = "alist_sized_push ";
	private static final Integer cmdsize=cmd.length();
	private final String key;
	private final Integer size;
	protected final byte[] data;

	public RomaAlistSizedPushOpImpl(OperationCallback cb, String k,Integer s,byte [] d) {
		super(cb);
		key=k;
		data=d;
		size=s;
