...
public class RomaAlistSwapPushOpImpl extends OperationImpl
	...
	private final static String cmd = "alist_swap_and_push ";
	private static final Integer cmdsize=cmd.length();
	private final String key;
	protected final byte[] data;

	public RomaAlistSwapPushOpImpl(OperationCallback cb, String k,byte [] d) {
		super(cb);
		key=k;
		data=d;
	}
