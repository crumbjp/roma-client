...
public class RomaAlistSwapSizedInsertOpImpl extends OperationImpl
	...
	private static final String cmd = "alist_swap_and_sized_insert ";
	private static final Integer cmdsize=cmd.length();
	private final String key;
	private final Integer size;
	protected final byte[] data;

	public RomaAlistSwapSizedInsertOpImpl(OperationCallback cb, String k,Integer s,byte [] d) {
		super(cb);
		key=k;
		data=d;
		size=s;
