...
public class RomaAlistSwapSizedPushOpImpl extends OperationImpl
	...
	private static final String cmd = "alist_swap_and_sized_push ";
	private static final Integer cmdsize=cmd.length();
	private final String key;
	private final Integer size;
	protected final byte[] data;

	public RomaAlistSwapSizedPushOpImpl(OperationCallback cb, String k,Integer s,byte [] d) {
		super(cb);
		key=k;
		data=d;
		size=s;
