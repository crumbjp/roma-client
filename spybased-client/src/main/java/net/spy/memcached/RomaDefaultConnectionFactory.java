...
public class RomaDefaultConnectionFactory extends SpyObject
	 ...
	 */
	public RomaDefaultConnectionFactory(int qLen, int bufSize, HashAlgorithm hash) {
		super();
		opQueueLen=qLen;
		readBufSize=bufSize;
		hashAlg=hash;
	 ...
	 */
	public RomaConnection createConnection(List<InetSocketAddress> addrs)
		throws IOException {
		return new RomaConnection(getReadBufSize(), this, addrs,
